...
const menuItems = mockData.sidebar.menuItems.map((item) => ({
  ...item,
...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed left-0 top-16 h-[calc(100vh-64px)] border-r border-[var(--color-border)] bg-black transition-all duration-300 z-40 ${
        collapsed ? 'w-20' : 'w-64'
        ...
        <div className="flex h-full flex-col">
          ...
          <button
            ...
            className="hidden md:flex w-full items-center justify-center border-t border-[var(--color-border)] p-4 text-gray-500 hover:text-white transition-colors"
          >
